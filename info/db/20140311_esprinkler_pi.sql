...
--
-- Host: localhost
-- Generation Time: Mar 12, 2014 at 04:16 AM
...
CREATE TABLE IF NOT EXISTS `settingsconfig` (
  ...
  `sc_webserver_url` text NOT NULL,
...
INSERT INTO `settingsconfig` (`sc_id`, `sc_site_title`, `sc_webserver_url`, `sc_last_updated`) VALUES
(1, 'eSprinkler - Pi', 'http://esprinkler.xyz.com/pi/rcvping.php', '2013-03-10 00:00:00');
